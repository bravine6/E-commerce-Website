      ...
      <div class="table-responsive cart_info"> 
              ...
              ?>
                         ...
                         <!-- <td></td> -->
                          ...
                          <td>KSH <?php echo  $result->PRODISPRICE ?></td>
                          <td>KSH <output><?php echo $_SESSION['gcCart'][$i]['price']?></output></td>
                        </tr>
              <?php
              ...
              ?>
                ...
                <div class="  pull-right">
                  <p align="right">
                  <div > Total Price :   KSH <span id="sum">0.00</span></div>
                   <div > Delivery Fee : KSH <span id="fee">0.00</span></div>
                   <div> Overall Price : KSH <span id="overall"><?php echo $tot ;?></span></div>
