	...
	"post">
				...
				<?php
				  ...
				  $query = "SELECT * 
						...
						echo '<tr>';  
				  		...
				  		?>
				  		 <td> KSH <output><?php echo number_format($result->ORDEREDPRICE,2); ?></output></td> 
				  		<?php
       ...
       <div class="row">
		  	...
		  	<div class="col-md-6 pull-right">
		  		<p align="right">Total Price : KSH <?php echo number_format($subtot,2);?></p>
		  		<p align="right">Delivery Fee : KSH <?php echo number_format($cur->DELFEE,2); ?></p>
		  		<p align="right">Overall Price : KSH <?php echo number_format($cur->PAYMENT,2); ?></p>
		  	</div>
		  </div> 
		</div>   
